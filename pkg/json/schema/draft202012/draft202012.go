...
//go:generate go run github.com/Motmedel/utils_go/pkg/json/schema/internal/cmd/keywordgen -p draft202012 -o keywords.go corekeywords.json applicatorkeywords.json
